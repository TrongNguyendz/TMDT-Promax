<template>
  <div class="space-y-4">
    ...
    <form @submit.prevent="handleSubmit" class="space-y-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label class="block text-sm font-medium">Tỉnh/Thành phố</label>
        ...
        <div>
          ...
          <input v-model="info.ward" type="text" class="input-field" placeholder="Phường/Xã *" />
        </div>
        <div>
          <label class="block text-sm font-medium">Phường/Xã</label><input v-model="info.district" type="text"
            class="input-field" placeholder="Quận/Huyện *" />
        </div>
        <div><label class="block text-sm font-medium">Địa chỉ chi tiết</label><input v-model="info.province" type="text"
            class="input-field" placeholder="Tỉnh/Thành phố *" /></div>
      </div>
      ...
      <div class="flex gap-3 pt-4">
        <button type="button" @click="$emit('prev')" class="flex-1 rounded-lg border border-gray-300 px-4 py-3">Quay
          lại</button>
...
<style scoped>
.input-field {
  @apply mt-1 w-full rounded-lg border border-gray-300 px-4 py-2 dark:border-gray-700 dark:bg-gray-900;
}
