          ...
          >
            ...
            >
              <span
                :class="[
                  ...
                  styleDeliveryType(order.delivery_type),
                ]"
              >
            ...
            <td class="p-4">
              <div class="flex items-center justify-center gap-2">
                ...
                <button
                  v-if="
                    ['pending', 'takepacking', 'shipping', 'deliver'].includes(
                      order.status,
                    )
                  "
...
const getDeliveryTypeLabel = (type) => {
  ...
  return map[type] || "Giao hàng bình thường";
};
  ...
  if (nextStatus && confirm(msg)) {
    try {
      ...
      if (res.data.success) {
        uiStore.pushToast({
          type: "success",
          message: `Đã chuyển sang trạng thái: ${getStatusLabel(nextStatus)}`,
        });
...
const styleDeliveryType = (type) => {
  const map = {
    1: "bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-500",
    2: "bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-500",
    3: "bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-500",
  };
  return (
    map[type] ||
    "bg-gray-100 text-gray-700 dark:bg-gray-900/30 dark:text-gray-500"
  );
};
