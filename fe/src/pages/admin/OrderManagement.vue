<template>
	...
	<div class="mb-6 flex gap-4 flex-wrap items-end">
		...
		<div class="min-w-[160px]">
			<label class="block text-[10px] font-black uppercase tracking-widest text-gray-400 mb-2 ml-1">Trạng
				thái</label>
		...
		<div class="flex-1 min-w-[280px]">
			<label class="block text-[10px] font-black uppercase tracking-widest text-gray-400 mb-2 ml-1">Tìm
				kiếm</label>
			<div class="relative">
					...
					<td class="p-3">
						<div class="flex items-center justify-center gap-2">
							...
							<button v-if="['pending', 'processing'].includes(order.status)"
								@click="updateStatus(order.id, 'shipping')" title="Chuyển sang Đang giao"
							...
							<button v-if="['pending', 'processing', 'unpaid'].includes(order.status)"
								@click="cancelOrder(order.id)" title="Hủy đơn"
