<template>
  <section class="space-y-10">
    ...
    <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
      <!-- Doanh thu -->
      <div class="group relative overflow-hidden rounded-[2rem] border border-gray-100 bg-white p-6 shadow-sm transition-all hover:shadow-xl dark:border-gray-800 dark:bg-gray-900">
        <div class="flex items-center justify-between mb-4">
          ...
          <span class="text-[10px] font-bold text-green-500 bg-green-50 dark:bg-green-900/20 px-2 py-1 rounded-full">+12%</span>
        </div>
        <p class="text-[10px] font-black uppercase tracking-widest text-gray-400">Doanh thu tuần này</p>
        <p class="mt-1 text-2xl font-black text-gray-900 dark:text-white">{{ formatCurrency(stats.revenueWeek || 0) }}</p>
      </div>
      ...
      <div class="group relative overflow-hidden rounded-[2rem] border border-gray-100 bg-white p-6 shadow-sm transition-all hover:shadow-xl dark:border-gray-800 dark:bg-gray-900">
        <div class="flex items-center justify-between mb-4">
          ...
          <span class="text-[10px] font-bold text-blue-500 bg-blue-50 dark:bg-blue-900/20 px-2 py-1 rounded-full">Mới</span>
        </div>
...
<div class="rounded-xl bg-gray-50 p-2 dark:bg-gray-800">
	...
	<div class="mt-6 rounded-lg border p-4 bg-white dark:bg-gray-800 dark:border-gray-700">
        ...
        <h2 class="text-sm font-black uppercase tracking-widest text-gray-900 dark:text-white italic">Đơn hàng gần đây</h2>
